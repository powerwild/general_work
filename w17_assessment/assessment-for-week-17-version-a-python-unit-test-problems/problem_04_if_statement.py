...
def simple_german_translator(string):
    if string.lower() == 'guten, tag' or string.lower() == 'hallo': return 'Hello'
    elif string.lower() == 'tschuss' or string.lower() == 'auf wiedersehen': return 'Bye'
    elif string.lower() == 'ich liebe dich': return 'I love you'
    elif string.lower() == 'wo sind sie': return 'Where are you'
    else: return None
