...
def test_configuration_has_database_setting():
    ...
    for component in ["postgresql://", "app_academy", "password", "localhost", "pyweb_test_db"]:
...
def test_simple_form_data_retrieval(client):
    ...
    with app.app_context():
        ...
        db.session.add(Instrument(date_bought="1953-12-13",
                                  nickname="Mary",
                                  year="1953",
                                  maker="Gibson",
                                  type="String",
                                  used=False))
        db.session.add(Instrument(date_bought="1987-5-10",
                                  nickname="Blue",
                                  year="1983",
                                  maker="Fernandes",
                                  type="String",
