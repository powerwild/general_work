...
SELECT city, (population_estimate_2018 / 1000000 || ' million') AS population_estimate_2018 FROM cities
WHERE state = 'Texas';
...
SELECT city, state, (population_estimate_2018 / 1000000 || ' million') AS population_estimate_2018 FROM cities
...
SELECT city, land_area_sq_mi_2016, population_estimate_2018 FROM cities
WHERE land_area_sq_mi_2016 <= 400 AND population_estimate_2018 >= 2000000 OR land_area_sq_mi_2016 > 400 AND population_estimate_2018 < 2000000;
...
SELECT city, state, to_char(population_estimate_2018, '000,000,000') AS population_estimate_2018 FROM cities;
...
SELECT city, (ROUND((ROUND(population_estimate_2018, 2) / 1000000), 2) || ' million') AS population_estimate_2018 FROM cities
WHERE state = 'Texas';
