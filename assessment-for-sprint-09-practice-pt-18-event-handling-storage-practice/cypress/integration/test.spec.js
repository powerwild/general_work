describe("Element selection, event handling, and local storage practice", function () {
  ...
  describe("Problem 7 (2 points)", function () {
    it("concatenates apples/oranges or clears basekt on button press", function () {
      cy.get('#add-apple')
        .click();
...
describe("Problem 9", function () {
  it("fetches and displays data", function () {
    ...
    cy.get('#results-area ul').children()
      ...
      .should('contain', 'Origin: early 16th century: from medieval Latin dictionarium (manuale ) or dictionarius (liber ) ‘manual or book of words’, from Latin dictio (see diction).')
  });
});